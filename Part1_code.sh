...
# - "how do i run quast against a reference genome for ecoli"
# - "why is my genome fraction 88% and not 100% is that bad"
# - "what does n50 tell me about my assembly quality"
# - "spades says command not found what do i do"
